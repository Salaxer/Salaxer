        ...
        <>
            <div className="ContainerSkills">
                ...
                <div className="logoContainer">
                    ...
                    <span aria-hidden>LabView</span>
                </div>
                <div className="logoContainer">
                    <img title="Proteus" style={{width: '100px'}} src="https://www.labcenter.com/images/proteus-logo-with-text.png" alt="Proteus."></img>
                </div>
                <div className="logoContainer">
                    <svg aria-label="Arduino." xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 25" fill="none" data-inject-url="https://cdn.arduino.cc/header-footer/prod/assets/headerLogo-arduino.svg">
                        <title>Arduino</title>
