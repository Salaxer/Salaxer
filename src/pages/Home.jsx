        ...
        <Helmet>
          ...
          <div className="descriptionAboutMe">
            ...
            <ul className="textForDescription workDescription">
              <li tabIndex={0}><h4 >January 2022 - April 2022.</h4><h4>Professional practices | CIRCUTEC</h4>
                <p style={{paddingTop: '10px'}}>
                  ...
                  {/* <br/><code aria-label="tecnologias usadas">Technologies:</code>
                  <br/><code>FrontEnd: Angular, TypeScript, HTML5, CSS3, MQTT</code>
                  <br/><code>BackEnd: hidden </code>
                  <br/><code>Database: hidden </code> */}
                </p>
              </li>
              <li tabIndex={0}><h4>April 2019 - December 2021.</h4><h4>Restaurant brand | Doña Martha</h4>
                <p style={{paddingTop: '10px'}}>
