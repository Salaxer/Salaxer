...
import './works.css'
import { getAllWorks } from "../../api/theWorks";
...
const Works = () => {
  ...
  return (
      <div className="viewWorks">
        ...
        <motion.section animate={!details ? "animate" : "hidden"} variants={containerListW} className="containerListWorks">
        ...
        { myWorks.length > 0 &&
          <motion.div animate={details ? "animate" : "hidden"} variants={containerDetailW} className="containerWork">
